---
name: update-cheatsheet-azure
description: Web-search for Azure AI/MLOps updates, diff against the Azure cheatsheet, and propose changes for approval
---

# Skill: /update-cheatsheet-azure

Keep `reference/azure-ai-mlops-cheatsheet.md` current with the latest Azure AI and MLOps announcements.
