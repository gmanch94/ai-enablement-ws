---
name: update-cheatsheet-aws
description: Web-search for AWS AI/MLOps updates, diff against the AWS cheatsheet, and propose changes for approval
---

# Skill: /update-cheatsheet-aws

Keep `reference/aws-ai-mlops-cheatsheet.md` current with the latest AWS AI and MLOps announcements.
