---
name: update-cheatsheet-opensource
description: Web-search for OSS AI/MLOps releases, diff against the OSS cheatsheet, and propose changes for approval
---

# Skill: /update-cheatsheet-opensource
