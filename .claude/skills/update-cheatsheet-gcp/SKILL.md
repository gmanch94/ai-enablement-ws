---
name: update-cheatsheet-gcp
description: Web-search for GCP AI/MLOps updates, diff against the GCP cheatsheet, and propose changes for approval
---

# Skill: /update-cheatsheet-gcp

Keep `reference/gcp-ai-mlops-cheatsheet.md` current with the latest Google Cloud AI and MLOps announcements.
