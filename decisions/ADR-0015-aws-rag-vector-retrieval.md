...
5. **Managed Knowledge Base capability expansion** — the Jun 2026 GA adds native data connectors, Smart Parsing (automatic multi-format document prep), an Agentic Retriever for multi-step queries, and direct AgentCore Gateway integration, further reducing the custom pipeline code teams need to write.
